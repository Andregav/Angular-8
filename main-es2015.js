...
/* harmony import */ var _units_units_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./units/units.component */ "./src/app/units/units.component.ts");
...
const routes = [
    { path: '', component: _units_units_component__WEBPACK_IMPORTED_MODULE_3__["UnitsComponent"] },
    { path: ':link', component: _list_list_component__WEBPACK_IMPORTED_MODULE_4__["ListComponent"] },
    { path: ':link/:linkName', component: _patient_patient_component__WEBPACK_IMPORTED_MODULE_5__["PatientComponent"] }
];
...
/* harmony import */ var _units_units_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./units/units.component */ "./src/app/units/units.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _units_units_component__WEBPACK_IMPORTED_MODULE_7__["UnitsComponent"],
...
/* harmony import */ var _units_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../units.service */ "./src/app/units.service.ts");
...
let ListComponent = class ListComponent {
    constructor(route, unitsService, location) {
        this.route = route;
    ...
    sortName() {
        ...
        patients.sort((a, b) => this.toggle ? +(a.name > b.name) || -(a.name < b.name) : -(a.name > b.name) || +(a.name < b.name));
    }
    sortDx() {
        this.toggle = !this.toggle;
        let patients = this.link.patient;
        patients.sort((a, b) => this.toggle ? +(a.dx > b.dx) || -(a.dx < b.dx) : -(a.dx > b.dx) || +(a.dx < b.dx));
    }
    sortVisit() {
        this.toggle = !this.toggle;
        let patients = this.link.patient;
        patients.sort((a, b) => this.toggle ? +(a.date > b.date) || -(a.date < b.date) : -(a.date > b.date) || +(a.date < b.date));
    }
    sortStaff() {
        this.toggle = !this.toggle;
        let patients = this.link.patient;
        patients.sort((a, b) => this.toggle ? +(a.staff > b.staff) || -(a.staff < b.staff) : -(a.staff > b.staff) || +(a.staff < b.staff));
    }
    onSearch() {
...
let PatientComponent = class PatientComponent {
    constructor(route, unitsService, taskService, location) {
        this.route = route;
        this.unitsService = unitsService;
...
PatientComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./patient.component.scss */ "./src/app/patient/patient.component.scss")).default]
    })
], PatientComponent);
...
/* harmony import */ var _data_task__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./data_task */ "./src/app/data_task.ts");
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _patient_patient_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../patient/patient.component */ "./src/app/patient/patient.component.ts");



let TaskComponent = class TaskComponent {
    constructor(patientComponent) {
    ...
    saveSubtask() {
        let x = document.getElementById("subtaskDescription");
        let y = document.getElementById("datein");
        let z = document.getElementById("dateout");
        let w = document.getElementById("subtaskName");
        if (w.value == '') {
            this.notSelect = true;
        }
        else {
...
let UnitsService = class UnitsService {
    ...
    getLink(link) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(_data__WEBPACK_IMPORTED_MODULE_3__["DATA"].find(list => list.link === link));
    }
    getPatient(patient) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(_data__WEBPACK_IMPORTED_MODULE_3__["DATA"].find(patient => patient === patient));
    }
};
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _units_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../units.service */ "./src/app/units.service.ts");
...
UnitsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-units',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./units.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/units/units.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./units.component.scss */ "./src/app/units/units.component.scss")).default]
    })
], UnitsComponent);
...
module.exports = __webpack_require__(/*! F:\project\test\hospital\code\src\main.ts */"./src/main.ts");
